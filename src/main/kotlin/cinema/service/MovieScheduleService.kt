...
class MovieScheduleService(
    ...
    fun updateMovieWithSchedules(movieSchedule: MovieWithSchedules) = movieScheduleRepository.updateMovieWithSchedules(movieSchedule)

    fun deleteSchedule(scheduleId: Long) = movieScheduleRepository.deleteSchedule(scheduleId)
    ...
    fun deleteMovieSchedule(movieId: String) = movieScheduleRepository.deleteMovieSchedule(movieId)
}
